...
public class RepProdxCatControlador extends GenericForwardComposer<Component>{
	...
	public void onClick$buttonImprimir(){
		...
		try {
	          ...
	          Paragraph Titulo=new Paragraph("Reporte de Productos Por Categoría "+cmb_tiempo.getText(),miFuente);
	...
	public void onClick$buttonAceptarA(){
		...
		lista = dbrp.ReportePorAño(cmb_anio.getText(),cmb_Categoria.getText());
