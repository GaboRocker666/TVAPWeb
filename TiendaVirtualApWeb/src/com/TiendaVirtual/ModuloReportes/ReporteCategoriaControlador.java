...
import com.TiendaVirtual.modelos.DBReporteCategoria;
...
public class ReporteCategoriaControlador extends GenericForwardComposer<Component>
{
	...
	DBReporteCategoria dbrp=new DBReporteCategoria();
	ArrayList<ReportesCategoriaentidad> lista;
	@Override
	...
	public void onClick$buttonImprimir(){
		...
		try {
	          ...
	          PdfPCell celda;
	          PdfPCell c1;
	          ReportesCategoriaentidad rowlista;
				...
				celda=new PdfPCell(new Phrase("Año",miFuente2));
		          ...
		          tabla.addCell(celda);
		          celda=new PdfPCell(new Phrase("Nombre de Categoría",miFuente2));
		          celda.setHorizontalAlignment(Element.ALIGN_CENTER);
	      	      celda.setVerticalAlignment(Element.ALIGN_CENTER);
		          tabla.addCell(celda);
		          celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		Executions.getCurrent().createComponents("Modulo_Reportes/Pdf_Viewer.zul", win_reportescategorias,h);
	...
	public void onClick$buttonAceptarA(){
		...
		ListModelList<ReportesCategoriaentidad> modeloDeDatos= new ListModelList<ReportesCategoriaentidad>(lista);
