...
public class subProductosControlador extends GenericForwardComposer<Component>{
//enlace a los componentes de la interfaz
	@Wire
	Button buttonnuevoproductos, buttonbusquedaproductos,buttonedicionproductos;
	Window winProductos;
	Center centro= null;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		super.doAfterCompose(comp);
		 centro = (Center)winProductos.getAttribute("centro");
	...
	public void onClick$buttonnuevoproductos(){
   ...
   public void onClick$buttonbusquedaproductos(){
  	if(centro.getFirstChild()!=null){
  	 centro.removeChild(centro.getFirstChild());
  	 }
   ...
   public void onClick$buttonedicionproductos(){
  	if(centro.getFirstChild()!=null){
  	 centro.removeChild(centro.getFirstChild());
  	 }
