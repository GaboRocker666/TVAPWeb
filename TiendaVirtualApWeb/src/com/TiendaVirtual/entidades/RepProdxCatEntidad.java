...
public class RepProdxCatEntidad {
	...
	public RepProdxCatEntidad(String finicial, String ffinal, int ctpedidos,
			String categoria, String productos) {
		super();
